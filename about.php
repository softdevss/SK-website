                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 mb-30">
                                    <div class="select-itms">
                                        <select name="select" id="select2">
                                            <option value="">Below 10</option>
                                            <option value="">10 to 17 years old</option>
                                            <option value="">18 to 59 years old</option>
                                            <option value="">60 years old and above</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="submit-info">
                                        <button class="btn" type="submit">Register now <i class="ti-arrow-right"></i> </button>
                                    </div>
                                </div>
                            </div>
                        </form>
