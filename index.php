                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                            <div class="hero__caption">
                                ...
                                <h1 class="cd-headline letters scale">Committed to successsss Youth 
                                ...
                                <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.5s">Be A Volunteer <i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>          
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-tittle text-center mb-100">
                        ...
                        <p><h2>SK Accomplishment Report for the 1st Semester of Year 2021</h2></p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blogs mb-30">
                        ...
                        <div class="blogs-cap">
                            ...
                            <h4><a href="https://www.facebook.com/photo?fbid=1500456023624996&set=pcb.1500456140291651">PHILIPPINES YOUTH HERO AWARD</a></h4>
                            <a href="https://www.facebook.com/photo?fbid=1500456023624996&set=pcb.1500456140291651" class="read-more1">Read more</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blogs mb-30">
                        <div class="blog-img">
                            <img src="assets/img/gallery/blog4.png" alt="">
                        </div>
                        <div class="blogs-cap">
                            <div class="date-info">
                            ...
                            <h4><a href="https://www.facebook.com/manningarky/photos/pcb.1727613140752539/1727612870752566/">SUPPORT TO COMMUNITY PANTRIES</a></h4>
                            <a href="https://www.facebook.com/manningarky/photos/pcb.1727613140752539/1727612870752566/" class="read-more1">Read more</a>
                        </div>
                    </div>
                </div>
            </div>
